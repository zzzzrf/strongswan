	...
	auth_method_t auth, shared_key_t *shared_key)
{
	...
	DBG4(DBG_IKE, "HASH(Ni_b | Nr_b) %B", &hash);
	...
	*((uint64_t*)spi_r.ptr) = id->get_responder_spi(id);
	...
	DBG4(DBG_IKE, "CKY-I | CKY-R %B", &data);
	...
	DBG4(DBG_IKE, "CKY-I | CKY-R | 0 %B", &data);
	...
	DBG4(DBG_IKE, "SKEYID_d = PRF(SKEYID, CKY-I | CKY-R | 0) %B", &this->skeyid_d);
	chunk_clear(&data);

	/* SKEYID_a = prf(SKEYID, SKEYID_d | CKY-I | CKY-R | 1) */
	data = chunk_cat("cccc", this->skeyid_d, spi_i, spi_r, octet_1);
	DBG4(DBG_IKE, "SKEYID_d | CKY-I | CKY-R | 1 %B", &data);
	...
	DBG4(DBG_IKE, "SKEYID_a = PRF(SKEYID, SKEYID_d | CKY-I | CKY-R | 1) %B", &this->skeyid_a);
	chunk_clear(&data);

	/* SKEYID_e = prf(SKEYID, SKEYID_a | CKY-I | CKY-R | 2) */
	data = chunk_cat("cccc", this->skeyid_a, spi_i, spi_r, octet_2);
	DBG4(DBG_IKE, "SKEYID_a | CKY-I | CKY-R | 2 %B", &data);
	...
	DBG4(DBG_IKE, "SKEYID_e = PRF(SKEYID, SKEYID_a | CKY-I | CKY-R | 2) %B", &skeyid_e);
	chunk_clear(&data);
